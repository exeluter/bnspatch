...
<p align="center">
  ...
  <a href=""><img src="https://img.shields.io/appveyor/build/zeffy/bnspatch?logo=appveyor&logoColor=ccc&style=for-the-badge"/></a>
...
3. Updating the embedded dependencies is a little tricky. They are deflated with
   ...
   the compressed data needs to be prepended to the beginning of the `.deflate` file.
...
While bnspatch does make use of a `winmm.dll` proxy, which is also used for
multi-client (and the XIGNCODE3 bypass as well, previously).
