...
//
bool FastWildCompare(wchar_t const *pWild, wchar_t const *pTame)
{
     wchar_t const *pWildSequence;  // Points to prospective wild string match after '*'
     wchar_t const *pTameSequence;  // Points to prospective tame string match
