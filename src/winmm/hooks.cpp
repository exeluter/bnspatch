  ...
  for ( auto const &current : children ) {
    if ( !_wcsicmp(current.name(), L"parent") ) {
      ...
      if ( !_wcsicmp(current.name(), L"select-node") ) {
        ...
        auto xn = context_node.select_node(current.attribute(L"proto-query").value());
        ...
        process_patch(
          context_node.prepend_move(context_node.select_node(current.attribute(L"moved-query").value()).node()),
          current.children());
      } else if ( !_wcsicmp(current.name(), L"append-move") ) {
        process_patch(context_node.append_move(context_node.select_node(current.attribute(L"moved-query").value()).node()), current.children());
      } else if ( !_wcsicmp(current.name(), L"attribute") ) {
        process_patch({ context_node.attribute(current.attribute(L"name").value()), context_node }, current.children());
        ...
        process_patch(context_node.child(current.attribute(L"name").value()), current.children());
        ...
        process_patch(context_node.first_element_by_path(current.attribute(L"path").value()), current.children());
      } else if ( !_wcsicmp(current.name(), L"insert-attribute-before") ) {
        auto name = current.attribute(L"name").value();
        auto attr_query = current.attribute(L"attr-query").value();
        ...
        process_patch(
          context_node.insert_child_after(
            current.attribute(L"name").value(),
            context_node.select_node(current.attribute(L"query").value()).node()),
          current.children());
