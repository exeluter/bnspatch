...
using ic_string = std::basic_string<char, ::ic_char_traits<char, int>>;
using ic_string_view = std::basic_string_view<char, ::ic_char_traits<char, int>>;

using ic_wstring = std::basic_string<wchar_t, ::ic_char_traits<wchar_t>>;
using ic_wstring_view = std::basic_string_view<wchar_t, ::ic_char_traits<wchar_t>>;
